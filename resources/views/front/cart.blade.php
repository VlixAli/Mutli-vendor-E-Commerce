                    ...
                    <div class="total-amount">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    <ul>
                                        <li>Cart Total<span>{{ Currency::format($cart->total()) }}</span></li>
                                        <li>Taxes <span>{{ Currency::format(2.5) }}</span></li>
                                        <li>Tips <span>{{ Currency::format(1) }}</span></li>
                                        <li class="last">You Pay<span>{{ Currency::format($cart->total() + 3.5) }}</span></li>
                                    </ul>
                                    <div class="button">
